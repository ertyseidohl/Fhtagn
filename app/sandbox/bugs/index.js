...
;(function(exports) {
	...
	exports.ScreenBug = function (ctx) {
	...
	exports.ScreenBug.prototype = {
		...
		draw: function () {
			...
			this.ctx.drawRotatedImage(this.sprites[this.currentSprite], this.pos.x, this.pos.y, this.rotation - Math.PI / 2);
